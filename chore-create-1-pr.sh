...
function create_pr {
    ...
    # push to remote
    git add "packages/fe-eslint/$FILE_NAME"
    git add "packages/fe-prettier/$FILE_NAME"
    git add "packages/fe-cerberus/$FILE_NAME"
    git add "packages/fe-mortal/$FILE_NAME"
    git add "packages/fe-components/$FILE_NAME"
    git add "apps/fe-cassandra/$FILE_NAME"
    git add "apps/fe-hades/$FILE_NAME"
    git add "apps/fe-storybook/$FILE_NAME"
